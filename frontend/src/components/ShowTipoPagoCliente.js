...
const URI = 'http://localhost:8000/api/tipo-pago-cliente'; // Cambia esto si es necesario

const CompShowTipoPagoCliente = () => {
    ...
    return (
        <div className="container mt-5">
            ...
            <h2 className='text-center display-6' style={{ marginTop: '70px', color: '#343a40', fontWeight: 'bold', paddingBottom: '10px' }}>
                    Tipos de Pago de Clientes
                </h2>
                <div className="align-self-end mb-3">
                    <Link to='/factura-cliente/tipo-pago-cliente/create' className='btn btn-primary'>
                        ...
                        {tiposPago.map(tipo => (
                            <tr key={tipo.id}>
                                ...
                                <td className="text-center">
                                    <Link to={`/factura-cliente/tipo-pago-cliente/edit/${tipo.id}`} className='btn btn-warning btn-sm me-2'>
            ...
            <div className="mt-4">
                <button onClick={() => navigate('/factura-cliente/gestion-facturas-clientes')} className="btn btn-secondary">
...
export default CompShowTipoPagoCliente;
