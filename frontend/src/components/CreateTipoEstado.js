...
const CompCreateTipoEstado = () => {
    const [id, setId] = useState(''); // Nuevo estado para el ID
    ...
    const handleSubmit = async (e) => {
        ...
        const newTipoEstado = {
            id, // Incluir el ID en el objeto a enviar
            descripcion
        };
    ...
    return (
        <div className='container mt-5' style={{ marginTop: '120px' }}> {/* Aumentar el margen superior */}
            <h2 className='text-center mb-4'>Crear Tipo de Estado</h2>
            ...
            <form onSubmit={handleSubmit} className="needs-validation" noValidate>
                <div className="mb-3">
                    <label className="form-label">ID</label> {/* Campo para el ID */}
                    <input
                        type="text"
