...
const URI = 'http://localhost:8000/api/pago-cliente'; // Cambia esto si es necesario

const CompShowPagoCliente = () => {
    ...
    return (
        <div className="container mt-5">
            <div className="row">
                ...
                <h2 className='text-center display-6' style={{ marginTop: '70px', color: '#343a40', fontWeight: 'bold', paddingBottom: '10px' }}>Pagos de Clientes</h2>
                                ...
                                {grupo.pagos && grupo.pagos.length > 0 ? (
                                    grupo.pagos.map((pago) => (
                                        <tr key={pago.id}>
                                            ...
                                            <td>Q.{pago.monto}</td>
                                            <td>{pago.tipo_pago_cliente ? pago.tipo_pago_cliente.descripcion : 'No disponible'}</td>
                                        </tr>
                                    ))
                                ) : (
                                    <tr>
                    ...
                    <div className="d-flex justify-content-between mt-4">
                        ...
                        <button
                            ...
                            onClick={() => navigate('/factura-cliente/tipo-pago-cliente/gestion-tipos-pagos-clientes')}
...
export default CompShowPagoCliente;
